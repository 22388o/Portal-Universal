...
install_xcframework "${PODS_ROOT}/OpenSslKit-Universal.swift/OpenSslKit/Frameworks/OpenSSL.xcframework" "OpenSslKit-Universal.swift" "framework" "macos-arm64_x86_64"
