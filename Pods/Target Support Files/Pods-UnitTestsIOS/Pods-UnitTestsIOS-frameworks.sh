...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CNIODarwin-iOS/CNIODarwin.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CNIOHTTPParser-iOS/CNIOHTTPParser.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CNIOLinux-iOS/CNIOLinux.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CNIOSHA1-iOS/CNIOSHA1.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CNIOWindows-iOS/CNIOWindows.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Erc20Kit-Universal-iOS/Erc20Kit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EthereumKit-Universal-iOS/EthereumKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FeeRateKit-Universal.swift-iOS/FeeRateKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GRDB.swift-iOS/GRDB.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HdWalletKit-Universal.swift-iOS/HdWalletKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Hodler-Universal.swift-iOS/Hodler.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RxCombine-iOS/RxCombine.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SVGKit-iOS/SVGKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Secp256k1Kit-Universal.swift-iOS/Secp256k1Kit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftNIO-iOS/NIO.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftNIOConcurrencyHelpers-iOS/NIOConcurrencyHelpers.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftNIOCore-iOS/NIOCore.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftNIOEmbedded-iOS/NIOEmbedded.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftNIOFoundationCompat-iOS/NIOFoundationCompat.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftNIOHTTP1-iOS/NIOHTTP1.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftNIOPosix-iOS/NIOPosix.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftNIOSSL-iOS/NIOSSL.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftNIOTLS-iOS/NIOTLS.framework"
