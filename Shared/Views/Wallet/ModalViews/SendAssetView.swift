        ...
        VStack(spacing: 0) {
            ...
            case .recipient:
                VStack(alignment: .leading, spacing: 11) {
                    ...
                    PTextField(text: $viewModel.receiverAddress, placeholder: "Enter \(viewModel.coin.code) address", upperCase: false, width: 334, height: 48)
                        .overlay(
                            RoundedRectangle(cornerRadius: 24)
                                .stroke(viewModel.addressIsValid ? Color.clear : Color.red, lineWidth: 1)
                        )
            ...
            case .summary:
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        PTextField(text: $viewModel.memo, placeholder: "Enter private description or memo", upperCase: false, width: 334, height: 48)
                    }
            ...
            HStack {
                if viewModel.step != .sent {
                    ...
                    PButton(label: viewModel.step != .summary ? "Continue" : "Send", width: 100, height: 48, fontSize: 14, enabled: viewModel.actionButtonEnabled) {
                        withAnimation(.easeInOut(duration: 0.2)) {
                            switch viewModel.step {
                            case .recipient:
                                viewModel.step = .amount
